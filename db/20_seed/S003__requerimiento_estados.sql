...
===============================================================================
  ...
  el ciclo de observacion (REQ-26 a REQ-30). La indagacion de mercado, la CCP y
  la orden entran con V010 y S004.
...
INSERT INTO @RolModulo VALUES
  ('AREA_JEFE','REQUERIMIENTO'), ('AREA_ESPECIALISTA','REQUERIMIENTO'),
...
/* REQ-10: la firma del documento tecnico es del Jefe o titular del Area
   usuaria, en los cinco formatos. El Especialista elabora y deriva. */
...
INSERT INTO @DocFirma VALUES
  ...
  ('REQ_TDR_LOCACION','AREA_JEFE',1),
  ('REQ_TDR_CONSULTORIA','AREA_JEFE',1),
  ('REQ_PROPUESTA_LOCACION','AREA_JEFE',1);
...
INSERT INTO @Tr VALUES
  ...
  ('REQ_FIRMAR_AU', 'REQ_PEND_FIRMA_AU', 'REQ_FIRMADO_AU',
  ...
  ('REQ_DERIVAR_DEC', 'REQ_EN_EVAL_OA', 'REQ_EN_EVAL_DEC',
...
INSERT INTO @TrRol VALUES
  ...
  ('REQ_DERIVAR_JEFE','AREA_ESPECIALISTA'), ('REQ_DERIVAR_JEFE','AREA_JEFE'),
  ('REQ_FIRMAR_AU','AREA_JEFE'),
  ('REQ_REMITIR_OA','AREA_JEFE'),
  ('REQ_REMITIR_DAI','AREA_JEFE'),
  ('REQ_OBSERVAR_OA','OA'),
  ('REQ_DERIVAR_DEC','OA'),
  ('REQ_OBSERVAR_DEC','ABAST_ESPECIALISTA'), ('REQ_OBSERVAR_DEC','ABAST_COORDINADOR'),
  ('REQ_OBSERVAR_DAI','DAI'),
  /* REQ-16: el resultado de la revision lo decide el Coordinador, no el
     Especialista que recepciona. */
  ('REQ_NO_OBJECION_DEC','ABAST_COORDINADOR'),
  ('REQ_ACEPTAR_NO_OBJECION','AREA_JEFE'),
  ('REQ_CONFORMIDAD_DEC','ABAST_COORDINADOR'),
